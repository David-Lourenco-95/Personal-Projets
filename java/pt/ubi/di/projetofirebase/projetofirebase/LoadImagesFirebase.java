...
// Classe que mostra ao utilizador o teste ou trabalho através de um conjunto de imagens
// com a possibilidade de download
public class LoadImagesFirebase extends AppCompatActivity {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        for (String s : arrayList) {
                            ViewPagerAdapter adapter  = new ViewPagerAdapter(LoadImagesFirebase.this, arrayList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.Download:
                ...
                if(ContextCompat.checkSelfPermission(LoadImagesFirebase.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    startDownload();
                }
                else {
                ...
                for (String s : Link) {
                    ...
                    teste.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            DonwloadFiles(LoadImagesFirebase.this,Teste,".jpeg", DIRECTORY_DOWNLOADS,url);
                        }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ActivityCompat.requestPermissions(LoadImagesFirebase.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},WRITE_PERMISSION_CODE);
                        }
                    })
...
@Override
  ...
  @Override
    public void onBackPressed() {
        ...
        Intent iActivity5 = new Intent(LoadImagesFirebase.this, ListViewTestes.class);
