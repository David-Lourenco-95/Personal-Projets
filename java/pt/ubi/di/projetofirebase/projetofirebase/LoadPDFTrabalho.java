...
public class LoadPDFTrabalho extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                new LoadPDFTrabalho.RetrivePdfStream().execute(url);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.Download:
                ...
                if(ContextCompat.checkSelfPermission(LoadPDFTrabalho.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED){
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                teste.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        DonwloadFiles(LoadPDFTrabalho.this,Trabalho,".pdf",DIRECTORY_DOWNLOADS,url);
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ActivityCompat.requestPermissions(LoadPDFTrabalho.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},WRITE_PERMISSION_CODE);
                        }
                    })
    ...
    public void onBackPressed() {
        ...
        Intent iActivity5 = new Intent(LoadPDFTrabalho.this, ListViewTrabalhos.class);
