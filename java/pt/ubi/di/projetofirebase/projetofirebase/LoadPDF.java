...
public class LoadPDF extends AppCompatActivity {
    ...
    // Declaração da Storage onde estão os PDFs
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.Download:
                ...
                if(ContextCompat.checkSelfPermission(LoadPDF.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    startDownload();
                }
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                teste.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        DonwloadFiles(LoadPDF.this, Teste, ".pdf",  DIRECTORY_DOWNLOADS , url);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ActivityCompat.requestPermissions(LoadPDF.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_PERMISSION_CODE);
                        }
                    })
    ...
    public void onBackPressed() {
        ...
        Intent iActivity5 = new Intent(LoadPDF.this, ListViewTestes.class);
