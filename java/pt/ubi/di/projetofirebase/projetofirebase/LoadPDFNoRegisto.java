...
public class LoadPDFNoRegisto extends AppCompatActivity {

    private PDFView pdfView;

    // Declaração da Storage que onde estão os PDFs
    ...
    private String Curso = "", Disciplina = "", Teste = "", Link = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collectionReference = mDatabaseRef.collection("Cursos").document(Curso).collection("Disciplinas").document(Disciplina).collection("Testes");

        documentReference = collectionReference.document(Teste);

        // Função que pesquisa por um determinado teste no formato PDF e o retorna para o utilizador
        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                new LoadPDFNoRegisto.RetrivePdfStream().execute(url);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.Download:
                ...
                if(ContextCompat.checkSelfPermission(LoadPDFNoRegisto.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    startDownload();
                }
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                teste.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        DonwloadFiles(LoadPDFNoRegisto.this, Teste, ".pdf",  DIRECTORY_DOWNLOADS , url);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ActivityCompat.requestPermissions(LoadPDFNoRegisto.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_PERMISSION_CODE);
                        }
                    })
    ...
    public void onBackPressed() {
        ...
        Intent iActivity5 = new Intent(LoadPDFNoRegisto.this, ListViewTestesNoRegisto.class);
