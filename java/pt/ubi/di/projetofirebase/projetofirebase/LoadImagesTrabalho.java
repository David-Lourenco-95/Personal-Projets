...
public class LoadImagesTrabalho extends AppCompatActivity {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        for (String s : arrayList) {
                            ViewPagerAdapter adapter  = new ViewPagerAdapter(LoadImagesTrabalho.this, arrayList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.Download:
                ...
                if(ContextCompat.checkSelfPermission(LoadImagesTrabalho.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    startDownload();
                }
                else {
                ...
                for (String s : Link) {
                    ...
                    teste.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            DonwloadFiles(LoadImagesTrabalho.this,Trabalho,".jpeg",DIRECTORY_DOWNLOADS,url);
                        }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ActivityCompat.requestPermissions(LoadImagesTrabalho.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},WRITE_PERMISSION_CODE);
                        }
                    })
    ...
    public void onBackPressed() {
        ...
        Intent iActivity5 = new Intent(LoadImagesTrabalho.this, ListViewTrabalhos.class);
