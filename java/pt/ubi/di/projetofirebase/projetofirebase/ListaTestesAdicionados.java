...
public class ListaTestesAdicionados extends AppCompatActivity {
    ...
    private String  Curso="",Disciplina="", aluno="",TesteRemover="", val="",linkPDF="", formato="";
   ...
   private ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_testes_adicionados);
        ...
        // Query que permite listar os testes e trabalhos adicionados por um determiando utilizador
        collectionReference.whereEqualTo("Utilizador",aluno).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                for(QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots){
                    ...
                    String nome = documentSnapshot.getString("Teste");
                    String merge = curso+"\n"+ disciplina+" \n"+ nome;

                    arrayList.add(merge);

                }
                // Adapter que adiciona a arraylist com a informação á listView

                adapter = new ArrayAdapter(ListaTestesAdicionados.this, R.layout.adapter_testes ,R.id.nome_teste,arrayList);
        ...
        // Função que permite remover um teste que foi adicionado por um determinado utilizador
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                    ...
                    TesteRemover = val.substring(val.indexOf(" \n") + 2, val.length());

                    // Caixa de dialogo que pergunta ao utilizador se pretende eleminar o teste selecionado
                    AlertDialog.Builder mBuilder = new AlertDialog.Builder(ListaTestesAdicionados.this);
                    View mView = getLayoutInflater().inflate(R.layout.dialog_remove_lista_testes_adicionados, null);
                    ...
                    btnCancelar.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            // Função que remove o teste selecionado
                            documentReference = collectionReference.document(TesteRemover);
                                ...
                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                 ...
                                 formato = documentSnapshot.getString("Formato");
                                    ...
                                    if (formato.equals(".img")) {
                                        ...
                                        documentReference2 = collectionReference.document(TesteRemover);
                                        documentReference2.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                if (task.isSuccessful()) {
                                                    ...
                                                    dialog.dismiss();
                                                    adapter.notifyDataSetChanged();
                                                    Toast.makeText(ListaTestesAdicionados.this, "Teste removido com sucesso", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        ...
        Intent iActivity5 = new Intent(ListaTestesAdicionados.this, DescricaoDisciplina.class);
