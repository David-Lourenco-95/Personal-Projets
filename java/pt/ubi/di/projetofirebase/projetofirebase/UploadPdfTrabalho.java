...
public class UploadPdfTrabalho extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_pdf_trabalho);
        ...
        BtnPDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ContextCompat.checkSelfPermission(UploadPdfTrabalho.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
    ...
    protected void onActivityResult( final int requestCode,  final int resultCode,  final Intent data) {
        ...
        if(data == null){
            Toast.makeText(UploadPdfTrabalho.this, "Escolha um ficheiro!", Toast.LENGTH_SHORT).show();
            return;
        }
                    ...
                    if (auth.getCurrentUser() != null) {
                        ...
                        if (data.getData() != null) {
                            ...
                            if(TextUtils.isEmpty(NomeTeste)) {
                                Toast.makeText(UploadPdfTrabalho.this, "Insira um nome para o ficheiro!", Toast.LENGTH_SHORT).show();
                                return;
                            }
                                ...
                                mUlploadTask = fileToUpload.putFile(uri).
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                ...
                                                Toast.makeText(UploadPdfTrabalho.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
                        }
    ...
    public void VazioPDFTrabalho (View v) {
        if(TextUtils.isEmpty(NomeTeste)) {
            Toast.makeText(UploadPdfTrabalho.this, "Escolha um Ficheiro!", Toast.LENGTH_SHORT).show();
            return;
        }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(UploadPdfTrabalho.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, STORAGE_PERMISSION_CODE);
                        }
                    })
    ...
    public void onBackPressed() {
        ...
        Intent iActivity5 = new Intent(UploadPdfTrabalho.this, DescricaoDisciplina.class);
