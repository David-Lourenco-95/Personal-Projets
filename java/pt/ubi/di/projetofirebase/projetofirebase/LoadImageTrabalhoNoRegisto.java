...
public class LoadImageTrabalhoNoRegisto extends AppCompatActivity {
    ...
    String Curso="",Disciplina="",Trabalho = "";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_load_images_trabalho);
        ...
        // Função que vai pesquisar um trabalho na base de dados e retornar a infomação ao utilizador
        collectionReference.document(Trabalho).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        // ArrayList que contem uma ou mais imagens
                        ArrayList<String> arrayList = (ArrayList<String>) document.get("urlImagem");

                        // Ciclo que vai popular a ViewPager com as imagens do trabalho
                        for (String s : arrayList) {
                            ViewPagerAdapter adapter  = new ViewPagerAdapter(LoadImageTrabalhoNoRegisto.this, arrayList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.Download:
                ...
                if(ContextCompat.checkSelfPermission(LoadImageTrabalhoNoRegisto.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    startDownload();
                }
                else {
                ...
                for (String s : Link) {
                    ...
                    teste.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            DonwloadFiles(LoadImageTrabalhoNoRegisto.this,Trabalho,".jpeg",DIRECTORY_DOWNLOADS,url);
                        }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ActivityCompat.requestPermissions(LoadImageTrabalhoNoRegisto.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},WRITE_PERMISSION_CODE);
                        }
                    })
    ...
    public void onBackPressed() {
        ...
        Intent iActivity5 = new Intent(LoadImageTrabalhoNoRegisto.this, ListViewTrabalhosNoRegisto.class);
