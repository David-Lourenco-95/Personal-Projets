...
public class ListViewTrabalhos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collectionReference.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                adapter = new ArrayAdapter(ListViewTrabalhos.this, R.layout.adapter_testes ,R.id.nome_teste, arrayList);
                ...
                documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        if(formato.equals(".img")) {
                            ...
                            Intent iActivity = new Intent(getApplicationContext(), LoadImagesTrabalho.class);
                        ...
                        // Se o trabalho for um PDF , então vai para a respetiva atividade
                            ...
                            Intent iActivity = new Intent(getApplicationContext(), LoadPDFTrabalho.class);
    ...
    public void onBackPressed() {
        ...
        Intent iActivity5 = new Intent(ListViewTrabalhos.this, DescricaoDisciplina.class);
